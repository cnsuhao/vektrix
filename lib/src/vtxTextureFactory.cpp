...
namespace vtx
{
	...
	//-----------------------------------------------------------------------
	Texture* DefaultTextureFactory::createObject(vtx::Movie* movie, vtx::Resource* resource)
	{
		return new DefaultTexture(-1);
	}
	//-----------------------------------------------------------------------
	void DefaultTextureFactory::destroyObject(Texture* instance)
	{
		delete instance;
		instance = NULL;
	}
